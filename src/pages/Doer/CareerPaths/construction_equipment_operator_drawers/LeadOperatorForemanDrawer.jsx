...
const LeadOperatorForemanDrawer = ({ toggle, open }) => {
  const handleClose = () => {
    toggle();
  };
      ...
      <div class="p-4">
          ...
          <div className="w-full mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.indeed.com/q-Lead-Operator-Foreman-jobs.html"
                  )
                }
              >
                <div className="p-4 md:p-5">
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.indeed.com/jobs?q=lead+operator+foreman&l=Minneapolis%2C+MN"
                  )
                }
              >
                <div className="p-4 md:p-5">
        ...
        <div class="space-y-2 mt-6 mb-4 ">
          ...
          <div className="w-full prose prose-li marker:text-black mb-4 ">
            Managing teams of operators, overseeing daily equipment operations, and ensuring the timely and safe completion of construction projects.
          </div>
        </div>
        <div class="space-y-2 mt-6 mb-4">
          <label
          ...
          <div class="mb-4">
            <ul className="list-disc px-3 ">
              <li class="mt-1 text-gray-700">
                <p>Supervise and assign tasks to equipment operators.</p>
              </li>
              <li class="text-gray-700">
                <p>Oversee equipment usage and maintenance schedules.</p>
              </li>
              <li class="text-gray-700">
                <p>Ensure compliance with safety protocols and project deadlines.</p>
              </li>
            </ul>
          </div>
        </div>
        <div class="space-y-2 mt-6 mb-4">
          ...
          <div class="mb-4">
            <ul className="list-disc px-3 ">
              <li class="mt-1 text-gray-700">
                <p>5+ years of equipment operating experience.</p>
              </li>
              <li class="text-gray-700">
                <p>Strong leadership and communication skills.</p>
              </li>
              <li class="text-gray-700">
                <p>Proficiency in project planning and team management.</p>
              </li>
            </ul>
          </div>
        </div>
...
export default LeadOperatorForemanDrawer;

...
const MaintenanceTechnicianDrawer = ({toggle, open}) => {
        ...
        <div class="cursor-default">
              ...
              <div className="flex flex-col bg-white border shadow-sm rounded-xl">
                <div className="p-4 md:p-5">
                  ...
                  <div className="mt-1 flex items-center gap-x-2">
                    <h3 className="text-xl sm:text-2xl font-medium text-gray-800">$35,000 - $45,000</h3>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="w-full prose prose-li marker:text-black mb-4">
              Perform routine maintenance tasks, assist in machinery repairs, and ensure equipment remains operational under the guidance of senior mechanics.
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div class="mb-4">
              <ul className="list-disc px-3">
                <li class="mt-1 text-gray-700">Inspect and maintain machinery components.</li>
                <li class="text-gray-700">Lubricate and clean machinery regularly.</li>
                <li class="text-gray-700">Assist with basic repairs and part replacements.</li>
              </ul>
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div class="mb-4">
              <ul className="list-disc px-3">
                ...
                <li class="text-gray-700">Basic mechanical aptitude and familiarity with tools.</li>
                <li class="text-gray-700">Willingness to learn and follow safety protocols.</li>
              </ul>
            </div>
          </div>
        </div>
...
export default MaintenanceTechnicianDrawer;

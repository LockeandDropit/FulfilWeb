...
const ExperiencedEquipmentOperatorDrawer = ({toggle, open}) => {
      ...
      <div class="p-4">
          ...
          <div className="w-full mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div
                ...
                onClick={() =>
                  window.open(
                    "https://www.indeed.com/q-Experienced-Equipment-Operator-jobs.html"
                  )
                }
              >
                <div className="p-4 md:p-5">
        ...
        <div class="space-y-2 mt-6 mb-4 ">
          ...
          <div className="w-full prose prose-li marker:text-black mb-4 ">
            Operating a range of heavy equipment, including bulldozers, cranes, and graders, with minimal supervision while following project specifications and safety regulations.
          </div>
        </div>
        <div class="space-y-2 mt-6 mb-4">
          <label
          ...
          <div class="mb-4">
            <ul className="list-disc px-3 ">
              <li class="mt-1 text-gray-700">
                <p>
                  Operate and maintain heavy machinery for construction projects.
                </p>
              </li>
              <li class="text-gray-700">
                <p>Interpret blueprints and site plans for accurate work.</p>
              </li>
              <li class="text-gray-700">
                <p>Ensure compliance with safety and environmental standards.</p>
              </li>
            </ul>
          </div>
        </div>
        <div class="space-y-2 mt-6 mb-4">
          ...
          <div class="mb-4">
            <ul className="list-disc px-3 ">
              <li class="mt-1 text-gray-700">
                <p>2-5 years of experience in equipment operation.</p>
              </li>
              <li class="text-gray-700">
                <p>Familiarity with safety protocols and environmental rules.</p>
              </li>
              <li class="text-gray-700">
                <p>Ability to operate multiple types of heavy machinery.</p>
              </li>
            </ul>
          </div>
        </div>
...
export default ExperiencedEquipmentOperatorDrawer;

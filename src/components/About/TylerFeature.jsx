...
<div class="max-w-6xl px-4 sm:mt-6 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto max-sm:p-6">
  ...
  <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
    <div class="hidden md:block mb-24 md:mb-0 sm:px-6">
      <div class="relative">
        <img class="rounded-xl" src="/landingImages/HeadshotGood.jpg" alt="Avatar" />

      
        <div class="absolute bottom-0 start-0 -z-[1] translate-y-10 -translate-x-14">
          <svg class="max-w-40 h-auto text-gray-400 " width="696" height="653" viewBox="0 0 696 653" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
      ...
      <blockquote class="relative">
        <svg class="absolute top-0 start-0 transform -translate-x-8 -translate-y-4 size-24 text-gray-200 " width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="relative z-10">
          <p class="text-lg font-semibold text-gray-500 tracking-wide uppercase mb-3 ">
            From our founder
          </p>

          <p class="text-base font-medium italic text-gray-800  md:leading-normal xl:text-xl xl:leading-normal ">
          I created Fulfil to be exactly what I needed when I was younger. Coming out of high school, I had no idea what my options were or how to pursue them. At Fulfil, we're committed to giving as many people as possible the tools needed to thrive in the job market, regardless of background

or desired profession. When people are underutilized, it hurts not just them, but society as a whole. This is a solvable problem, and we're dedicated to solving it. Together, we can unlock the potential in every individual and create a more prosperous society for all.
          </p>
        </div>

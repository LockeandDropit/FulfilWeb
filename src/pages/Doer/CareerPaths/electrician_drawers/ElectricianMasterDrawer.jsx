...
const ElectricianMasterDrawer = ({ toggle, open }) => {
  const handleClose = () => {
    toggle();
  };
        ...
        <div class="cursor-default">
          ...
          <div className="w-full mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="flex flex-col bg-white border shadow-sm rounded-xl">
                <div className="p-4 md:p-5">
                  ...
                  <div className="mt-1 flex items-center gap-x-2">
                    <h3 className="text-xl sm:text-2xl font-medium text-gray-800">$70,000 - $100,000</h3>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col bg-white border shadow-sm rounded-xl cursor-pointer" onClick={() => window.open("https://www.indeed.com/jobs?q=master+electrician&l=Minneapolis%2C+MN")}>
                <div className="p-4 md:p-5">
                  <div className="flex items-center gap-x-2">
          ...
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="w-full prose prose-li marker:text-black mb-4">
              Oversee complex electrical projects, design and implement systems, and manage teams of electricians while ensuring safety and compliance.
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="mb-4">
              <ul className="list-disc px-3">
                <li class="mt-1 text-gray-700">Design and oversee the installation of complex electrical systems.</li>
                <li class="text-gray-700">Inspect completed work to ensure quality and compliance.</li>
                <li class="text-gray-700">Manage and train teams of electricians and apprentices.</li>
              </ul>
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="mb-4">
              <ul className="list-disc px-3">
                <li class="mt-1 text-gray-700">7-10 years of experience as an electrician.</li>
                <li class="text-gray-700">Licensed master electrician certification.</li>
...
export default ElectricianMasterDrawer;

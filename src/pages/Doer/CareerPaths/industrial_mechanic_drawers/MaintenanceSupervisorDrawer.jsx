...
const MaintenanceSupervisorDrawer = ({ toggle, open }) => {
  const handleClose = () => {
    toggle();
  };
        ...
        <div class="cursor-default">
              ...
              <div className="flex flex-col bg-white border shadow-sm rounded-xl">
                <div className="p-4 md:p-5">
                  ...
                  <div className="mt-1 flex items-center gap-x-2">
                    <h3 className="text-xl sm:text-2xl font-medium text-gray-800">$75,000 - $95,000</h3>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="w-full prose prose-li marker:text-black mb-4">
              Supervise a team of maintenance technicians, create and manage maintenance schedules, and ensure all machinery operates efficiently with minimal downtime.
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div class="mb-4">
              <ul className="list-disc px-3">
                <li class="mt-1 text-gray-700">Develop and implement maintenance schedules.</li>
                <li class="text-gray-700">Monitor and improve team performance.</li>
                <li class="text-gray-700">Ensure compliance with safety standards and protocols.</li>
              </ul>
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div class="mb-4">
              <ul className="list-disc px-3">
                <li class="mt-1 text-gray-700">7-10 years of industrial maintenance experience.</li>
                <li class="text-gray-700">Proven leadership and organizational skills.</li>
                <li class="text-gray-700">Knowledge of safety and regulatory requirements.</li>
              </ul>
            </div>
          </div>
        </div>
...
export default MaintenanceSupervisorDrawer;

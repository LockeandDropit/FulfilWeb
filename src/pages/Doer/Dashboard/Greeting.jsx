...
const Greeting = ({user}) => {
  ...
  <div className="p-2 bg-white">
    ...
    <nav className="relative flex gap-x-1 after:absolute after:bottom-0 after:inset-x-0 after:border-b after:border-stone-200" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
      <h2 className="cursor-default hs-tab-active:after:bg-stone-800 hs-tab-active:text-stone-800 px-2.5 py-1.5 mb-2 relative inline-flex items-center gap-x-2  text-stone-500  text-base rounded-lg disabled:opacity-50  font-medium focus:outline-none focus:bg-stone-100 after:absolute after:-bottom-2 after:inset-x-0 after:z-10 after:h-0.5 active" id="hs-pro-tabs-dtsch-item-revenue" aria-selected="true" data-hs-tab="#hs-pro-tabs-dtsch-revenue" aria-controls="hs-pro-tabs-dtsch-revenue" role="tab">
        Progress Tracker
      </h2>
    ...
    <div>
      ...
      <div id="hs-pro-tabs-dtsch-revenue" role="tabpanel" aria-labelledby="hs-pro-tabs-dtsch-item-revenue">
        <div className="py-4">
          ...
          <div className="relative mt-3">
            <div className="flex w-full h-2 bg-stone-200 rounded-sm overflow-hidden" role="progressbar" aria-valuenow="72" aria-valuemin="0" aria-valuemax="100">
...
0
  ...
  <div>
    ...
    <a className="p-2 flex items-center gap-x-2 text-sm font-medium text-stone-800 rounded-lg hover:bg-stone-100 focus:outline-none focus:bg-stone-100 cursor-pointer" onClick={() => navigate("/Resources")}>
      <span className="flex shrink-0 justify-center items-center size-7 bg-white border border-stone-200 rounded-lg">

...
const HomepageJobs = () => {
  ...
  <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center ">
    <div className=''>
      <h1 class="block text-3xl font-semibold text-white sm:text-2xl lg:text-3xl lg:leading-tight ">Open Positions</h1>
      <p class="mt-2 text text-white">Browse open positions that fit your skill set.</p>
    </div>
  </div>

...
Back
     ...
     ({numberOfRatings} reviews)
        ...
        {/* <div className="flex flex-col"><button className='bg-sky-400 hover:bg-sky-500 px-3 py-2 h-10  rounded-lg text-white border-none outline-none cursor-pointer' >Send an offer</button>
    ...
    {chat?.messages?.map((message) => (
            ...
            <div class=" ">
              ...
              <p class="text-sm font-sm text-gray-400 leading-none">{format(message.createdAt.toDate())}</p> 
            </div>

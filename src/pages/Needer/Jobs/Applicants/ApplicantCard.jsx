...
const ApplicantCard = (props) => {
  ...
  const navigateApplicantProfile = (applicant) => {
    navigate("/ApplicantProfile", {state: {applicant: applicant, jobTitle: jobTitle, jobID: jobID, isHourly: isHourly}})
  }

  return (
    <div>
      {applicant && applicant.length > 25 ? (
              ...
              <div>
                ...
                >
                  ...
                  <CardBody>
                      ...
                      marginLeft="16px">
                        <Heading fontSize="24">{applicant.firstName} {" "} {applicant.lastName}</Heading>
                        {/* <Flex
                          direction="column"
                          position="absolute"
                          right="8"

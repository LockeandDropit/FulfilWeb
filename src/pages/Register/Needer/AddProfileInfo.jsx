          ...
          <form>
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
              <input
                ...
                value="Sign Up"
                onClick={() => checkLength()}
                class="py-2 px-3 inline-flex justify-center mb-12 items-center gap-x-2 text-start bg-sky-500  hover:bg-sky-600 text-white text-sm font-medium rounded-lg shadow-sm align-middle hover:bg-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-300 "
                data-hs-overlay="#"
              ></input>
            </div>
          </form>
        ...
        <ModalContent height="66vh">
          ...
          <ModalBody overflowY="scroll">
            <Text marginTop="8">
              ...
              overnight delivery service, if sent for next-day delivery. 1. Use
              of ChatGPT and Disclaimer of Accuracy The ChatGPT feature provided
              on the Fulfil website is designed to offer general information and
              guidance only. All responses generated by ChatGPT are based on AI
              algorithms and may not always reflect accurate, complete, or
              up-to-date information. Users are advised to verify the
              information before acting on it. Fulfil disclaims any
              responsibility for the accuracy, reliability, or suitability of
              responses provided by ChatGPT. 2. Limitation of Liability By using
              the ChatGPT feature on Fulfil, you acknowledge that any reliance
              on information provided by ChatGPT is at your own risk. Fulfil is
              not liable for any direct, indirect, incidental, consequential, or
              punitive damages arising from the use of ChatGPT, including any
              outcomes of employment decisions or job placements. Fulfil is not
              responsible for any advice, suggestions, or information provided
              by ChatGPT. 3. User Responsibility Users agree that they are
              solely responsible for evaluating and verifying any information or
              advice provided by ChatGPT. Fulfil does not endorse or guarantee
              the accuracy of any response and encourages users to seek
              additional information or professional advice before making
              decisions.
            </Text>
          </ModalBody>

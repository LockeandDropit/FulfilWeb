          ...
          <div class="sm:w-[286px] md:w-[300px] lg:w-full truncate bg-white lg:border-x border-gray-200">
            <div class="h-full flex flex-col">
              <div class="ps-4 pe-3 py-2 flex justify-between items-center gap-x-2 border-b border-gray-200">
                <h1 class="truncate font-semibold text-gray-800">Inbox</h1>
                ...
                >
                  <div aria-label="Tabs" role="tablist">
                    {chats ? (
                      chats.map((chat) => (
                        <div
                          class="hs-tab-active:bg-gray-200 relative cursor-pointer bg-white hover:bg-gray-100 focus:outline-none focus:bg-gray-100  "
                        ...
                        >
                          <div class="py-4 px-3 justify-between align-center  items-center flex gap-x-3 border-b border-b-gray-100">
                            <div class="flex-shrink-0">
                              <div class="relative size-8">
                                <span class="flex flex-shrink-0 justify-center items-center size-8 text-xs font-medium uppercase  text-white rounded-full">
                                  {chat.user.profilePictureResponse ? (
                                    <img

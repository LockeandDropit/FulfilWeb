...
const handleShowMobileAddJob = () => {
  ...
  return (
    <>
    <header class="lg:ms-[260px] fixed top-0 op-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 bg-white border-b border-gray-200">

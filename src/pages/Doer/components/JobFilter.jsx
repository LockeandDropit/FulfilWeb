    ...
    onSnapshot(q, (snapshot) => {
      ...
      snapshot.docs.forEach((doc) => {
        ...
        if (jobTitle && !minimumPay && !positionType) {
            ...
            if ( doc.data().lowerRate >= minimumPay && doc.data().isFullTimePosition === positionType) {
                console.log("heres your match with pay", doc.data())
                results.push(doc.data())
                  } else {
                    // onOpen()
...
search()
  ...
  return (
    <>
    {isDesktop ? (  <div class="w-full bg-white  px-4 sm:px-6 lg:px-8  ">
...
<div className=" w-[320px]">
          <label for="hs-select-label" class="block text-sm font-medium mb-1 ml-1">Pay Range</label>
<select  onChange={(e) => setMinimumPay(e.target.value)} id="hs-select-label"  value={minimumPay} class=" mb-2 py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
...
<div className=" w-[320px]">
          <label for="hs-select-label" class="block text-sm font-medium mb-1  ml-1">Position Type</label>
<select onChange={(e) => setPositionType(e.target.value)} id="hs-select-label" class="mb-2 py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
<option value={null}>Select position type</option>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
      ...
      <button class=" h-[48px] ml-4 w-auto sm:w-auto whitespace-nowrap  px-4 md:mt-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none cursor-pointer" onClick={() => search()}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
</svg>
  ...
  </div>) : (  <div class="w-full bg-white  px-4 sm:px-6 lg:px-8  mx-auto">
...
<select  onChange={(e) => setMinimumPay(e.target.value)} id="hs-select-label"  value={minimumPay} class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
<option value={null}>Select minimum pay</option>
  <option value="10">$10/hour +</option>
  <option value="15">$15/hour +</option>
  <option value="20">$20/hour +</option>
...
<select onChange={(e) => setPositionType(e.target.value)} id="hs-select-label" class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ">
<option value={null}>Select position type</option>
  <option value="true">Full-time</option>
  <option value="false">Part-time</option>
          ...
          <button class="w-full sm:w-auto whitespace-nowrap py-3 px-4  mt-2 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none cursor-pointer" onClick={() => search()}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
  <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
</svg>
    ...
    <div class="bg-white  rounded-xl shadow-sm pointer-events-auto ">
      <div class="p-4 sm:p-7">
        <div class="text-center">
          <h2 class="block text-xl sm:text-2xl font-semibold text-gray-800 ">No Results</h2>
      ...
      <div class="flex justify-end items-center ">
        ...
        <button onClick={() => onClose()} class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-sky-400 text-white hover:bg-sky-500 disabled:opacity-50 disabled:pointer-events-none" href="#">
        Continue
        </button>
      </div>

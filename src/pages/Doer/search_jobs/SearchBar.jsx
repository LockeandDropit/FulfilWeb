...
<div className="max-w-[84rem] w-full mx-auto mt-8 py-6 flex gap-y-2 lg:gap-y-0 lg:gap-x-5 px-5  rounded-md shadow-sm bg-sky-100">
  <div className='w-1/3'>
    ...
    <div className="relative">
      ...
      <input type="text" className="py-1.5 sm:py-3  rounded-xl px-3 ps-10 pe-8 block w-full bg-white  border-gray-200 xl:border-transparent sm:text-sm focus:bg-white focus:border-blue-500 focus:ring-blue-500 checked:border-blue-500 disabled:opacity-50 disabled:pointer-events-none xl:" placeholder="Search by file name or keyword" />
     
    </div>
  
  </div>
  <select className="py-2 px-4  w-1/6 border-none rounded-xl text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
  <option selected="">Date Posted</option>
  <option>1</option>
  <option>2</option>
  <option>3</option>
</select>
<select className="py-3 px-4 pe-9 w-1/6 border-none rounded-xl text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">

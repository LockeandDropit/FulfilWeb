...
const CarpenterJourneymanDrawer = ({toggle, open}) => {
        ...
        <div class="cursor-default">
          ...
          <div className="w-full mx-auto">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="flex flex-col bg-white border shadow-sm rounded-xl">
                <div className="p-4 md:p-5">
                  ...
                  <div className="mt-1 flex items-center gap-x-2">
                    <h3 className="text-xl sm:text-2xl font-medium text-gray-800">$45,000 - $60,000</h3>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col bg-white border shadow-sm rounded-xl cursor-pointer" onClick={() => window.open("https://www.indeed.com/jobs?q=journeyman+carpenter&l=Minneapolis%2C+MN")}>
                <div className="p-4 md:p-5">
                  <div className="flex items-center gap-x-2">
          ...
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="w-full prose prose-li marker:text-black mb-4">
              Work independently or as part of a team to install, repair, and maintain construction projects. Use advanced skills to ensure quality craftsmanship.
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="mb-4">
              <ul className="list-disc px-3">
                <li class="mt-1 text-gray-700">Install and repair frameworks, flooring, and cabinetry.</li>
                <li class="text-gray-700">Read and interpret blueprints and technical drawings.</li>
                <li class="text-gray-700">Ensure project accuracy and adhere to safety standards.</li>
              </ul>
            </div>
          </div>
          <div className="space-y-2 mt-6 mb-4">
            ...
            <div className="mb-4">
              <ul className="list-disc px-3">
                ...
                <li class="text-gray-700">Journeyman certification (if required in your region).</li>
                <li class="text-gray-700">Proficiency in carpentry tools and techniques.</li>
              </ul>
            </div>
          </div>
        </div>
...
export default CarpenterJourneymanDrawer;

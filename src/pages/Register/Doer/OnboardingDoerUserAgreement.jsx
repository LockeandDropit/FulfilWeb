...
const OnboardingDoerUserAgreement = () => {
  ...
  const agreeAndNavigate = () => {
   ...
   navigate("/OnboardingDoerTaxAgreement");
  };
...
<Center>
        ...
        >
          ...
          <Button colorScheme="blue" width="240px" onClick={() => skipAndNavigate()}>Skip</Button>
          <Button colorScheme="blue" width="240px" marginLeft="32px" onClick={() => agreeAndNavigate()}>I Agree</Button>
...
export default OnboardingDoerUserAgreement;

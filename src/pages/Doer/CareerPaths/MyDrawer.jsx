                           ...
                           {misc.OpeningsOrEducation.overview}
                            ...
                            <div className="flex items-center justify-center mt-auto mb-1">
                              ...
                              >
                                ...
                                <button
                                type="button"
                                class="ml-1 py-2 px-3 w-full inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border  bg-sky-400 text-white hover:bg-sky-600 shadow-sm   disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 "
                                onClick={() =>
                                 handleOpenLink(misc.OpeningsOrEducation)
                                }
                              >

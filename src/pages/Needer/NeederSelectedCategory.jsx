...
{premiumUsers ? ( premiumUsers.map((premiumUser) => (
  <>
  ...
  <div class="flex justify-between">
    <div class="flex flex-col justify-center items-center size-[56px]  ">
      {premiumUser.profilePictureRespone ? (<img src={premiumUser.profilePictureRespone}  class="flex-shrink-0 size-[38px] rounded-full" />) : (
         <svg
    ...
    <div>
      ...
      <label for="hs-pro-daicn1" class="relative py-2 px-2.5 w-full sm:w-auto block text-center sm:text-start rounded-lg cursor-pointer text-xs font-medium focus:outline-none text-sky-500 bg-blue-100">
        ...
        <span class="relative z-10 justify-center items-center gap-x-1.5 hidden peer-checked:flex peer-checked:text-gray-800 text-sky-500 ">
          <svg class="flex-shrink-0 size-3.5 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
    ...
    <Stack
                    ...
                    >
                      {premiumUser.premiumCategoryOne ? (
                         <span class="inline-flex items-center gap-x-1.5 py-1.5   px-3 r text-xs rounded-md font-medium bg-blue-100 text-sky-500 ">{premiumUser.premiumCategoryOne}</span>
                      ) : (
                        <span class="inline-flex items-center gap-x-1.5 py-1.5   px-3 r text-xs rounded-md font-medium bg-blue-100 text-sky-500 ">{premiumUser.premiumCategoryOne}</span>
                      )}

                      {premiumUser.premiumCategoryTwo ? (
                         <span class="inline-flex items-center gap-x-1.5 py-1.5  ml-1 px-3 r text-xs rounded-md font-medium bg-blue-100 text-sky-500 ">{premiumUser.premiumCategoryTwo}</span>
                      ) : null}
                      {premiumUser.premiumCategoryThree ? (
                         <span class="inline-flex items-center gap-x-1.5 py-1.5  ml-1 px-3 r text-xs rounded-md font-medium bg-blue-100 text-sky-500 ">{premiumUser.premiumCategoryThree}</span>
                      ) : null}
                    </Stack>
  ...
  <button type="button" onClick={() => handleOpenModal(premiumUser)} class="py-2 px-2  inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg  bg-sky-400 text-white shadow-sm hover:bg-sky-500  ">
    View profile
  </button>
</div>
...
<Modal isOpen={isOpen} onClose={onClose} size="6xl">
                ...
                >
                  ...
                  <div class="xl:pe-4 mt-3 space-y-5 divide-y divide-gray-200 ">
                    <div class="pt-4 first:pt-0">
                      ...
                      <div className="mt-2">
                        <button onClick={() => initiateRequest(premiumUser)} class="w-full py-2 px-4 inline-flex justify-center items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent bg-sky-400 text-white hover:bg-sky-500 disabled:opacity-50 disabled:pointer-events-none ">
                          Message
                        </button>
                      </div>
                    </div>
                                  ...
                                  <>
                                    <li>
                                      ...
                                      >
                                        ...
                                        <div class="grow">
                                          <p>{premiumUser.premiumCategoryOne}</p>
                                        </div>
                                      </a>
                                    </li>

                                    {premiumUser.premiumCategoryTwo ? null : (
                                     null
                                    )}
                                  </>
                                ) : null}
                                  ...
                                  <>
                                    <li>
                                      ...
                                      >
                                        ...
                                        <div class="grow">
                                          <p>{premiumUser.premiumCategoryTwo}</p>
                                        </div>
                                      </a>
                                    </li>
                                    {premiumUser.premiumCategoryThree ? null : (
                                     null
                                    )}
                                  </>
                                ) : null}
                                  ...
                                  <>
                                    <li>
                                      ...
                                      >
                                        ...
                                        <div class="grow">
                                          <p>{premiumUser.premiumCategoryThree}</p>
                                        </div>
                                      </a>
                                    </li>
                                    {premiumUser.premiumCategoryFour ? null : (
                                     null
                                    )}
                                  </>
                                ) : null}
                                  ...
                                  <>
                                    <li>
                                      ...
                                      >
                                        ...
                                        <div class="grow">
                                          <p>{premiumUser.premiumCategoryFour}</p>
                                        </div>
                                      </a>
                                    </li>
                                    {premiumUser.premiumCategoryFive ? null : (
                                    null
                                    )}
                                  </>
                                ) : null}
                                  ...
                                  <>
                                    <li>
                                      ...
                                      >
                                        ...
                                        <div class="grow">
                                          <p>{premiumUser.premiumCategoryFive}</p>
                                        </div>
                                      </a>
                                    </li>
                                  </>
                    ...
                    {user.bio ? (
                      <div class=" text-left flex justify-start w-full  bg-white  rounded-xl ">
                        <div class="h-full p-6">
                          <p class=" text-md  text-black ">{premiumUser.bio}</p>
                        </div>
                        {/* <!-- End Body --> */}
                      </div>
                    ) : (
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
      ...
      <div className="flex">
        ...
        <div className="grow-0 shrink-0  w-full h-full"><img className="w-full h-full" src={premiumUser.projectPictureOne} ></img></div>
        {premiumUser.projectPictureTwo ? (<div className="grow-0 shrink-0 w-full h-full"><img className="w-full"  src={premiumUser.projectPictureTwo} ></img></div>) : (null)}
        {premiumUser.projectPictureThree ? (<div className="grow-0 shrink-0 w-full h-full"><img className="w-full "  src={premiumUser.projectPictureThree} ></img></div>) : (null)}
        {premiumUser.projectPictureFour ? (<div className="grow-0 shrink-0 w-full h-full"><img className="w-full "  src={premiumUser.projectPictureFour} ></img></div>) : (null)}
        {premiumUser.projectPictureFive ? (<div className="grow-0 shrink-0 w-full h-full"><img className="w-full "  src={premiumUser.projectPictureFive} ></img></div>) : (null)}

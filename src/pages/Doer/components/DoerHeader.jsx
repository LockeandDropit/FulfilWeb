              ...
              <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                <div class="grow">
                  ...
                  <MenuItem onClick={() => navigate("/CareerPaths")}>
                      <p class="hs-accordion-toggle px-4 mb-1.5  w-full text-start flex    text-sm text-gray-800 rounded-lg hover:bg-gray-100 ">
                        {" "}
                        Career Paths
                      </p>
                    </MenuItem>
                    {/* <MenuItem onClick={() => navigate("/ResumeDashboard")}>
                      <p class="hs-accordion-toggle px-4 mb-1.5 hs-accordion-active:bg-gray-100 w-full text-start flex    text-sm text-gray-800 rounded-lg hover:bg-gray-100 ">
                        {" "}
                        Resume Builder
                      </p>
                    </MenuItem> */}

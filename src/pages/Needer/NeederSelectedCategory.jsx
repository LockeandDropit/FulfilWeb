      ...
      <main id="content" class="lg:ps-[260px] pt-[59px]">
        <div class="  px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <h1 class="block text-xl font-bold text-gray-800 sm:text-4xl lg:text-4xl lg:leading-tight">
            Looking at pros in{" "}
            <span class="text-sky-400">{selectedCategory}</span>
          </h1>
          <p class="mt-3 text-lg text-gray-800">
            Browse our contractors and send them a message!
          </p>
        </div>
          ...
          <div class="p-3  bg-white  shadow-sm rounded-xl ">
            <div class="grid sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5">
              {premiumUsers ? (
                    ...
                    <div class="p-5 space-y-4 flex flex-col bg-white border border-gray-200 rounded-xl ">
                      <div class="flex justify-between">
                        <div class="flex flex-col justify-center items-center size-[56px]  ">
                          {premiumUser.profilePictureRespone ? (
                            <img
                              src={premiumUser.profilePictureRespone}
                        ...
                        <div>
                          <label
                            for="hs-pro-daicn1"
                            class="relative py-2 px-2.5 w-full sm:w-auto block text-center sm:text-start rounded-lg cursor-pointer text-xs font-medium focus:outline-none text-sky-500 bg-blue-100"
                          >
                                      ...
                                      <div class="flex flex-col bg-white  rounded-xl shadow-sm xl:shadow-none ">
                                        ...
                                        <div class="space-y-2">
                                          <label class="block block mb-2 ml-5 text-sm font-medium text-gray-600 ">
                                            Upload attachments of work you've
                                            completed.
                                          </label>
                ...
                <div className="">
                  <p class="mt-3 text-lg text-gray-800">
                    Oops! No Pros listed in this category.
                  </p>
                  <p class="mt-3 text-lg text-gray-800">
                    Create A Job to find someone to complete your task.
                  </p>{" "}
                </div>
              )}
            </div>

...
const PlumberJourneymanDrawer = ({toggle, open}) => {
                ...
                <div class="overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 ">
                  <div class="p-4">
                    ...
                    <div class="space-y-2 mt-6 mb-4 ">
                      ...
                      A licensed plumber who can independently perform plumbing work and supervise apprentices.
                      </div>
                    </div>
                      ...
                      <div class="mb-4">
                        <ul className="list-disc px-3 ">
                          ...
                          <li class=" text-gray-700">
                            <p className="">
                            Troubleshoot complex plumbing issues.
                            </p>
                          </li>
                          <li class=" text-gray-700">
                            <p className="">
                            Work with contractors to ensure compliance with building codes.
                            </p>
                          </li>
                    ...
                    <div class="space-y-2 mt-6 mb-4">
                      ...
                      <div class="mb-4">
                        <ul className="list-disc px-3 ">
                          <li class="mt-1 text-gray-700">
                            <p className="">
                            Completion of an apprenticeship program and passing the journeyman licensing exam.
                            </p>
                          </li>
                          <li class=" text-gray-700">
                            <p className="">
                            Strong knowledge of local plumbing codes and safety standards.
                            </p>
                          </li>
...
export default PlumberJourneymanDrawer;
